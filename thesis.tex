...
On average, the decision fusion method has the best performance. And what is interesting in these results is that the ROC curves of the feature fusion and decision fusion methods are very close in all the cases.
